...
let loaders = new Map([
  ['Polka Dots', new DirectionalTileLoader('tiles/polka')],
  ['Tracks', new DirectionalTileLoader('tiles/demo-tracks')],
  ['Mountains', new DirectionalTileLoader('tiles/mountains').setEdgeFilter(onlyBlueFilter)],
  ['Pipes', (new DirectionalTileLoader('tiles/pipes')).setEdgeFilter(onlyGreenFilter)],
  ['Roads', new DirectionalTileLoader('tiles/roads')],
  ['Circuit tiles', new NumberedImagesTileLoader('tiles/circuit/', 13, [5])],
  ['Coding Train Circuit', new NumberedImagesTileLoader('tiles/circuit-coding-train/', 13, [5])],
  ['Rail', new NumberedImagesTileLoader('tiles/rail/tile', 7)],
  ['Flowers', new SingleImageTileLoader('../overlapping-model/images/Flowers.png', 3, 3)],
  ['Angular', new SingleImageTileLoader('../overlapping-model/images/Angular.png', 3, 3)],
  ['City', new SingleImageTileLoader('../overlapping-model/images/city.png', 3, 3)],
  ['Colored City', new SingleImageTileLoader('../overlapping-model/images/ColoredCity.png', 3, 3)],
  ['Disk', new SingleImageTileLoader('../overlapping-model/images/Disk.png', 3, 3)],
  ['Dungeon', new SingleImageTileLoader('../overlapping-model/images/Dungeon.png', 3, 3)],
  ['Knot', new SingleImageTileLoader('../overlapping-model/images/Knot.png', 3, 3)],
  ['Link 2', new SingleImageTileLoader('../overlapping-model/images/Link2.png', 3, 1)],
  ['Magic Office', new SingleImageTileLoader('../overlapping-model/images/MagicOffice.png', 3, 3)],
  ['Maze', new SingleImageTileLoader('../overlapping-model/images/Mazelike.png', 3, 3)],
  ['Office 2', new SingleImageTileLoader('../overlapping-model/images/Office2.png', 3, 3)],
  ['Platformer', new SingleImageTileLoader('../overlapping-model/images/Platformer.png', 3, 3)],
  ['Rooms', new SingleImageTileLoader('../overlapping-model/images/Rooms.png', 3, 3)],
  ['Sewers', new SingleImageTileLoader('../overlapping-model/images/Sewers.png', 3, 3)],
  ['Spirals', new SingleImageTileLoader('../overlapping-model/images/Spirals.png', 3, 3)],
  ['Town', new SingleImageTileLoader('../overlapping-model/images/Town.png', 3, 3)],
  ['Village', new SingleImageTileLoader('../overlapping-model/images/Village.png', 3, 3)],
])
